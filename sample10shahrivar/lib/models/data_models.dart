...
class BlogModel{
  ...
  String content;
  String views;
  BlogModel({required this.id,required this.imageUrl,required this.title,required this.writer,required this.writerImageUrl,required this.date,required this.content,required this.views});
}
class PodcastModel {
  int? id;
  String title;
...
List<PodcastModel> podcatList = [
  PodcastModel(id: 1, title: "ایلانی ها", poster: "https://tehranpodcast.ir/wp-content/uploads/2022/11/3000-2-400x400.jpg", publisher: "طاهره", view: "213", createdAt: "1403"),
  PodcastModel(id: 2, title: "ایلانی ها", poster: "https://tehranpodcast.ir/wp-content/uploads/2022/11/3000-2-400x400.jpg", publisher: "طاهره", view: "213", createdAt: "1403"),
  PodcastModel(id: 3, title: "ایلانی ها", poster: "https://tehranpodcast.ir/wp-content/uploads/2022/11/3000-2-400x400.jpg", publisher: "طاهره", view: "213", createdAt: "1403"),
  PodcastModel(id: 4, title: "ایلانی ها", poster: "https://tehranpodcast.ir/wp-content/uploads/2022/11/3000-2-400x400.jpg", publisher: "طاهره", view: "213", createdAt: "1403"),
  PodcastModel(id: 5, title: "ایلانی ها", poster: "https://tehranpodcast.ir/wp-content/uploads/2022/11/3000-2-400x400.jpg", publisher: "طاهره", view: "213", createdAt: "1403"),
